      ...
      <div className="Profile-Container">
        ...
        <div className="User-Accepted-Sessions-Container">
          ...
          {this.state.editProfile.acceptedSessions &&
            ...
            : <p className="empty-message"> You don't have any accepted sessions yet! </p>}
        </div>
        ...
        <div className="User-Accepted-Sessions-Container">
          <div className="Session-Container-Pending">
            {this.state.editProfile.pendingSessions &&
              ...
              : <p className="empty-message"> You don't have any pending sessions, people must really like you! </p>}
          </div>
        </div>
      </div>
    );
